(() => {
    ...
    let gotoblock_gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
        ...
        if (targetBlockElement) {
            ...
            document.documentElement.classList.contains("menu-open") ? burger_menuClose() : null;
    ...
    let formValidate = {
        ...
        formClean(form) {
            ...
            setTimeout((() => {
                ...
                if (modules_andModules.select) {
                    let selects = form.querySelectorAll(".select");
                    if (selects.length) for (let index = 0; index < selects.length; index++) {
                        const select = selects[index].querySelector("select");
                        modules_andModules.select.selectBuild(select);
                    }
                }
            }), 0);
        },
        ...
        async function formSubmitAction(form, e) {
            ...
            if (error === 0) {
                ...
                if (ajax) {
                    ...
                    } else form.classList.remove("_sending");
    ...
    modules_andModules.watcher = new ScrollWatcher({});
    class DynamicAdapt {
        constructor(type) {
            this.type = type;
        }
    ...
    da.init();
    console.log("Динамический адаптив есть");
    isWebp();
    addLoadedClass();
    menuInit();
    spollers();
